...
body = {
    # See lite.py: raw not-afk events from aw-watcher-afk, merged in
    # Python with IDLE_GAP_S=1800s (30 min) to reflect actual hands-on
    # interaction while tolerating reading / meeting pauses.
    "query": [
